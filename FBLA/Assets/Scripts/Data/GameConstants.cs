...
/*
 * GameConstants store essential game constant values.
 * Like Difficulty, this makes rapid prototyping possible
 * Data it stores includes pixel distances between UI elements,
 * Enemy healths, and various difficulty related changes in timers, scores, and rooms.
 */
public static class GameConstants {
	public static readonly int[] maxHearts = new int[] {10, 8, 6};
	...
	public static readonly float damageNumberTime = 2f;
	...
	public static readonly int[][] enemyChange = new int[][] {new int[] {1,2},new int[] {2,3},new int[] {2,4}};
}